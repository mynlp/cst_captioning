...
if __name__ == "__main__":
    ...
    parser.add_argument('metadata', type=str, default='datainfo', help='meta file')
    parser.add_argument('output', type=str, default='output/metadata/v2t2017_frameinfos.json', help='output file')
    parser.add_argument('--input_dir', type=str, default='input', help='root input dir')
    parser.add_argument('--img_type', type=str, default='rgb', choices=['rgb', 'flow_x', 'flow_y'], help='img_type')
    parser.add_argument('--dataset', type=str, default='msrvtt2017', help='dataset')
    parser.add_argument('--split', type=str, default='train', choices=['train', 'val', 'test'], help='img_type')
    parser.add_argument('--sampling_step', type=int, default=8, 
